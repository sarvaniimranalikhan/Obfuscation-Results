...
; <label>:7:                                      ; preds = %4
  ...
  %9 = sext i32 %8 to i64
  %10 = getelementptr inbounds [10 x float], [10 x float]* %2, i64 0, i64 %9
...
; <label>:15:                                     ; preds = %4
  ...
  %17 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %16, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.1, i32 0, i32 0))
  %18 = getelementptr inbounds [10 x float], [10 x float]* %2, i32 0, i32 0
  %19 = call float @_Z3iioPf(float* %18)
  %20 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEf(%"class.std::basic_ostream"* %17, float %19)
  ret i32 0
}
...
define linkonce_odr double @_ZSt3powIfiEN9__gnu_cxx11__promote_2IT_T0_NS0_9__promoteIS2_Xsr3std12__is_integerIS2_EE7__valueEE6__typeENS4_IS3_Xsr3std12__is_integerIS3_EE7__valueEE6__typeEE6__typeES2_S3_(float, i32) #5 comdat {
  %3 = alloca float, align 4
