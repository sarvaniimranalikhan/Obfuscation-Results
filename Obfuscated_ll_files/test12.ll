...
define i32 @_Z1ov() #4 {
  ...
  %4 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str, i32 0, i32 0))
...
; <label>:11:                                     ; preds = %6
  ...
  %13 = call zeroext i1 @_Z2IIi(i32 %12)
...
; <label>:14:                                     ; preds = %11
  ...
  %18 = call zeroext i1 @_Z2IIi(i32 %17)
...
; <label>:39:                                     ; preds = %36
  ...
  %42 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %41, i8* getelementptr inbounds ([49 x i8], [49 x i8]* @.str.3, i32 0, i32 0))
  br label %43
...
define zeroext i1 @_Z2IIi(i32) #5 {
  %2 = alloca i32, align 4
