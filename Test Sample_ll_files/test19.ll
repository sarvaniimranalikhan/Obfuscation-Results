...
%class.Check = type { i32 }

$_ZN5CheckC2Ev = comdat any

$_ZN5Check7DisplayEv = comdat any

$_ZN5CheckppEv = comdat any

@_ZStL8__ioinit = internal global %"class.std::ios_base::Init" zeroinitializer, align 1
@__dso_handle = external hidden global i8
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@.str = private unnamed_addr constant [3 x i8] c"i=\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_test19.cpp, i8* null }]
...
define i32 @main() #4 {
  ...
  %2 = alloca %class.Check, align 4
  store i32 0, i32* %1, align 4
  call void @_ZN5CheckC2Ev(%class.Check* %2)
  call void @_ZN5Check7DisplayEv(%class.Check* %2)
  call void @_ZN5CheckppEv(%class.Check* %2)
  call void @_ZN5Check7DisplayEv(%class.Check* %2)
  ret i32 0
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @_ZN5CheckC2Ev(%class.Check*) unnamed_addr #5 comdat align 2 {
  %2 = alloca %class.Check*, align 8
  store %class.Check* %0, %class.Check** %2, align 8
  %3 = load %class.Check*, %class.Check** %2, align 8
  %4 = getelementptr inbounds %class.Check, %class.Check* %3, i32 0, i32 0
  store i32 0, i32* %4, align 4
  ret void
}

; Function Attrs: noinline optnone uwtable
define linkonce_odr void @_ZN5Check7DisplayEv(%class.Check*) #6 comdat align 2 {
  %2 = alloca %class.Check*, align 8
  store %class.Check* %0, %class.Check** %2, align 8
  %3 = load %class.Check*, %class.Check** %2, align 8
  %4 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0))
  %5 = getelementptr inbounds %class.Check, %class.Check* %3, i32 0, i32 0
  %6 = load i32, i32* %5, align 4
  %7 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %4, i32 %6)
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @_ZN5CheckppEv(%class.Check*) #5 comdat align 2 {
  %2 = alloca %class.Check*, align 8
  store %class.Check* %0, %class.Check** %2, align 8
  %3 = load %class.Check*, %class.Check** %2, align 8
  %4 = getelementptr inbounds %class.Check, %class.Check* %3, i32 0, i32 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_test19.cpp() #0 section ".text.startup" {
