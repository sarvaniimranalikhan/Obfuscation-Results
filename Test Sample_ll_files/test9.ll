...
@.str.1 = private unnamed_addr constant [22 x i8] c"Standard Deviation = \00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_test9.cpp, i8* null }]
...
; <label>:8:                                      ; preds = %5
  ...
  %11 = getelementptr inbounds [10 x float], [10 x float]* %3, i64 0, i64 %10
  %12 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERf(%"class.std::basic_istream"* @_ZSt3cin, float* dereferenceable(4) %11)
  br label %13
...
; <label>:16:                                     ; preds = %5
  ...
  %18 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %17, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.1, i32 0, i32 0))
  %19 = getelementptr inbounds [10 x float], [10 x float]* %3, i32 0, i32 0
  %20 = call float @_Z11calculateSDPf(float* %19)
  %21 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEf(%"class.std::basic_ostream"* %18, float %20)
  ret i32 0
}
...
define float @_Z11calculateSDPf(float*) #5 {
...
; <label>:27:                                     ; preds = %24
  ...
  %34 = fsub float %32, %33
  %35 = call double @_ZSt3powIfiEN9__gnu_cxx11__promote_2IT_T0_NS0_9__promoteIS2_Xsr3std12__is_integerIS2_EE7__valueEE6__typeENS4_IS3_Xsr3std12__is_integerIS3_EE7__valueEE6__typeEE6__typeES2_S3_(float %34, i32 2)
...
define linkonce_odr double @_ZSt3powIfiEN9__gnu_cxx11__promote_2IT_T0_NS0_9__promoteIS2_Xsr3std12__is_integerIS2_EE7__valueEE6__typeENS4_IS3_Xsr3std12__is_integerIS3_EE7__valueEE6__typeEE6__typeES2_S3_(float, i32) #6 comdat {
  %3 = alloca float, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr float @_ZSt4sqrtf(float) #6 comdat {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_test9.cpp() #0 section ".text.startup" {
